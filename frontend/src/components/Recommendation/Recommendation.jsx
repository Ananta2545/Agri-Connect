...
const Recommendation = () => {
    ...
    // Here we are fetching the recommendation hehe
    const fetchRecommendation = async()=>{
        ...
        try{
            ...
            // Here splitting any empty strings
            const recommendationsArray = response.data.recommendation.split('\n').filter(item=> item.trim() !== '').map(item => item.replace(/^\*\s*/, '').trim()) // remove leading asterisk
